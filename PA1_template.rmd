...
```
According to out calculation the mean is `r mean` and the median is `r median`.
...
```
As you can see the maximum average is `r max` which is contained in 8:35-8:40 interval.  
